...
class MyDataTable extends StatelessWidget //__
  ...
  Widget build(context) //__
  {
    return DataTable(
      ...
      columns: const [
        DataColumn(
            label: Text('ID', style: AccordionScreen.contentStyleHeader),
            numeric: true),
        DataColumn(
            label:
            Text('Description', style: AccordionScreen.contentStyleHeader)),
        DataColumn(
            label: Text('Price', style: AccordionScreen.contentStyleHeader),
            numeric: true),
      ],
      rows: const [
        DataRow(
          cells: [
            DataCell(Text('1',
                style: AccordionScreen.contentStyle, textAlign: TextAlign.right)),
            DataCell(Text('Fancy Product', style: AccordionScreen.contentStyle)),
        ...
        DataRow(
          cells: [
            DataCell(Text('2',
                style: AccordionScreen.contentStyle, textAlign: TextAlign.right)),
            DataCell(
                Text('Another Product', style: AccordionScreen.contentStyle)),
        ...
        DataRow(
          cells: [
            DataCell(Text('3',
                style: AccordionScreen.contentStyle, textAlign: TextAlign.right)),
            DataCell(
                Text('Really Cool Stuff', style: AccordionScreen.contentStyle)),
        ...
        DataRow(
          cells: [
            ...
            DataCell(Text('Last Product goes here',
                style: AccordionScreen.contentStyle)),
    ...
    return Accordion(
      ...
      children: [
        AccordionSection(
          ...
          headerBackgroundColorOpened: Colors.black54,
          header:
          const Text('Nested Section #1', style: AccordionScreen.headerStyle),
          content: const Text(AccordionScreen.loremIpsum,
              style: AccordionScreen.contentStyle),
          contentHorizontalPadding: 20,
          contentBorderColor: Colors.black54,
        ),
        AccordionSection(
          ...
          header:
          const Text('Nested Section #2', style: AccordionScreen.headerStyle),
          headerBackgroundColor: Colors.black38,
          headerBackgroundColorOpened: Colors.black54,
          contentBorderColor: Colors.black54,
          content: const Row(
            children: [
              ...
              Flexible(
                  flex: 1,
                  child: Text(AccordionScreen.loremIpsum,
                      style: AccordionScreen.contentStyle)),
            ],
          ),
        ),
